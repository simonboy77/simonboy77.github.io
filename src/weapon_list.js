const weapons_S24 = [
	new Weapon('HAVOC', [
		new FireMode('Normal', 21.0, 1.3, 0.75, 11.2, 36, 36, 36, 36, 2.88, 2.88, 30500, 0),
		new FireMode('Beam', 70.0, 1.5, 1.0, 1.04, 36, 36, 36, 36, 2.88, 2.88, 0,
	...
	new Weapon('R-301', [
		new FireMode('Normal', 14.0, 1.3, 0.75, 15.5, 21, 23, 28, 31, 3.2, 2.4, 29000, 0)
	], Attachment.MAG | Attachment.STOCK, HopUp.SPLATTER, 0, 0),
	
	new Weapon('Nemesis', [
		new FireMode('Normal', 17.0, 1.3, 0.75, 18.0, 20, 24, 28, 32, 3.0, 2.7, 31000,
		             {burstSize:4,burstDelay:0.31,chargedBurstDelay:0.19,chargePerBurst:0.167}),
		new FireMode('Full Speed', 17.0, 1.3, 0.75, 18.0, 20, 24, 28, 32, 3.0, 2.7, 31000,
		             {burstSize:4,burstDelay:0.19})
	], Attachment.MAG | Attachment.STOCK, 0, 0, 0),
	
	new Weapon('Alternator', [
		new FireMode('Normal', 18.0, 1.2, 0.8, 10.0, 19, 23, 26, 28, 2.23, 1.9, 19000, 0)
	], Attachment.MAG | Attachment.STOCK, 0, 0, 0),
	...
	new Weapon('R-99', [
		new FireMode('Normal', 13.0, 1.2, 0.8, 18.0, 17, 20, 23, 26, 2.45, 1.8, 19000, 0)
	], Attachment.MAG | Attachment.STOCK, HopUp.SPLATTER, 0, 0),
	
	new Weapon('Volt', [
		new FireMode('Normal', 16.0, 1.25, 0.8, 12.0, 19, 21, 23, 26, 2.03, 1.44, 20000, 0)
	], Attachment.MAG | Attachment.STOCK, 0, 0, 0),
	
	new Weapon('C.A.R.', [
		new FireMode('Normal', 14.0, 1.25, 0.8, 15.4, 19, 22, 24, 27, 2.13, 1.7, 18000, 0)
	], Attachment.MAG | Attachment.STOCK, 0, 0, 0),
	...
	new Weapon('Spitfire', [
		new FireMode('Normal', 21.0, 1.25, 0.85, 9.0, 35, 40, 45, 50, 4.2, 3.4, 27500, 0)
	...
	new Weapon('Scout', [
		new FireMode('Normal', 35.0, 1.6, 0.75, 3.9, 10, 15, 18, 20, 3.0, 2.4, 30000, 0)
	], Attachment.MAG | Attachment.STOCK, 0, 0, 0),
	...
	new Weapon('Charge_Rifle', [
		new FireMode('Normal', 75.0, 2.0, 0.9, 0.616, 6, 7, 8, 9, 4.6, 3.5, 33999,
		             {fireDelay:0.868,maxBodyDamage:110.0}),
		new FireMode('Auto', 56.0, 2.0, 0.9, 1.394, 6, 7, 8, 9, 4.6, 3.5, 33999,
	...
	new Weapon('Longbow', [
		new FireMode('Normal', 60.0, 2.25, 0.9, 1.3, 6, 8, 10, 12, 3.66, 2.66, 30500, 0)
	], Attachment.MAG | Attachment.STOCK, HopUp.SPLATTER, 0, 0),
	...
	new Weapon('EVA-8', [
		new FireMode('Normal', 7.0, 1.25, 1.0, 2.6, 8, 8, 8, 8, 3.0, 2.75, 16000,
		             {projectileCount:8})
	...
	new Weapon('Mozambique', [
		new FireMode('Normal', 17.0, 1.25, 1.0, 2.66, 5, 5, 5, 5, 2.6, 2.1, 10000,
		             {projectileCount:3}),
	...
	new Weapon('P2020', [
		...
		new FireMode('Akimbo', 24.0, 1.25, 0.9, 8.0, 20, 22, 24, 28, 2.6, 2.1, 18500, 0)
	], Attachment.MAG, HopUp.SPLATTER, 0, 0),
	
	new Weapon('RE-45', [
		new FireMode('Normal', 14.0, 1.5, 0.9, 13.0, 20, 21, 23, 26, 1.95, 1.5, 19500, 0)
	], Attachment.MAG, HopUp.SPLATTER, 0, 0),
